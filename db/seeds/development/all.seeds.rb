...
city = FactoryGirl.create(:city, name: "Kazan", country: "Russian Federation")
city_2 = FactoryGirl.create(:city, name: "Moscow", country: "Russian Federation")
city_3 = FactoryGirl.create(:city, name: "New York", country: "USA")
...
FactoryGirl.create(:hotel, city: city_2, name: "AZIMUT Hotel Olympic Moscow", address: "Olympic ave. 18/1, Moscow",
  ...
  check_in_time: "30.09.2018 10:00:30".to_datetime)
FactoryGirl.create(:hotel, city: city_3, name: "Quality hotel & Suites at the falls",
  address: "240 First Street, Niagara Falls, NY", longitude: -79.047150, latitude: 43.092461,
  rating: 9.2, stars: 4, check_in_time: "30.09.2018 10:00:30".to_datetime)
